...
export default function Viewport() {
    ...
    }} key={data.id}><span style={{color: "rgb(0, 0, 62)", fontWeight:"600", fontSize:"36px"}}>**{data.title}**</span>  <br/> <span style={{color: "red", fontSize:"14px", textDecoration:"underline"}}>created By : {data.username}</span> </p>);
